        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    ...
                    Toast.makeText(authentication.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                } else {
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtOTP.getText().toString())) {
                    ...
                    Toast.makeText(authentication.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
...
//                            Toast.makeText(authentication.this, "Successful", Toast.LENGTH_SHORT).show();
                            Intent i = new Intent(authentication.this, get_name.class);
